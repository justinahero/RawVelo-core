...
// ErrNoPayload — پکتی که application layer نداره (مثل TCP SYN خالی)
// caller باید این رو skip کنه، نه به عنوان error واقعی handle کنه
var ErrNoPayload = errors.New("packet has no application layer payload")
